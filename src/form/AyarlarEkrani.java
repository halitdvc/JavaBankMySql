...
import form.ayarlar.TextAyarlari;
...
public class AyarlarEkrani extends javax.swing.JFrame implements IDuzenleyici, IBilgiController {
  ...
  private void telNoYenile() {
    ...
    private void initComponents() {
        ...
        geriIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form/iconlar/previousIcon.png"))); // NOI18N
        ...
        telNoDegistirIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form/iconlar/updateTelIcon.png"))); // NOI18N
        ...
        sifreDegistirIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form/iconlar/updateTelIcon.png"))); // NOI18N
    ...
    private void telNoDegistirIconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_telNoDegistirIconMouseClicked
        if (this.clickCounter == 0) { //daha önce tıklanmamışsa
           ...
           // IconAyarlari.changeIcon(telNoDegistirIcon, "updateTelIcon2");                 Hata veriyor?
            clickCounter++;
