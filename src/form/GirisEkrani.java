...
public final class GirisEkrani extends javax.swing.JFrame implements IDuzenleyici,IBilgiController {
    ...
    private void initComponents() {
        ...
        girisEkraniPanel.setBackground(new java.awt.Color(153, 255, 255));
        ...
        hosgeldinizLabel.setText("BANKAYA HOŞGELDİNİZ");
    ...
    */
    private void girisButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_girisButtonMouseEntered
        ButtonAyarlari.setBgFg(girisButton, Color.magenta, Color.green);
    ...
    */
    private void kimlikTextFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_kimlikTextFocusGained
        ...
        TextAyarlari.setMaxLimit(kimlikText, 11);  //sınır 11 olunca fareyi geldiğimzde tm okey sorun yok ama fareyi çektimizdfe KIMLIK_TEXT_ORGINAL 11 den büyük olduğundan istenilen olmuyor.
